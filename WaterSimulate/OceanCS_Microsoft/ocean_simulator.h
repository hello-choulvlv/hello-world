...
#define OMEGA_LEN 0x102810//==> 8 x  2 x 66177
...
protected:
    ...
    void init_height_map(ocean_parameter& params, std::vector<concurrency::graphics::float_2> &out_h0, std::vector<float> &out_omega);

    void init_buffers(ocean_parameter& params, std::vector<concurrency::graphics::float_2> &h0_data, std::vector<float> &omega_data, std::vector<concurrency::graphics::float_2> &zero_data);
	...
	concurrency::array_view<const concurrency::graphics::float_2> *m_array_view_float2_h0;

    // Angular frequency/½ÇÆµÂÊ
	concurrency::array_view<const float> *m_array_view_float_omega;

    // Height array H(t), choppy array Dx(t) and Dy(t) in frequency domain, updated each frame.
	concurrency::array_view<concurrency::graphics::float_2> *m_array_view_float2_ht;
	...
	concurrency::array_view<concurrency::graphics::float_2> *m_array_view_float_dxyz;
