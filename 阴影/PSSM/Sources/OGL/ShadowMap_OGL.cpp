...
bool ShadowMap_OGL::CreateAsTextureArray(int iSize, int iArraySize)
{
  ...
  glTexImage3D (GL_TEXTURE_2D_ARRAY_EXT, 0, GL_DEPTH_COMPONENT32F_NV, iSize, iSize, iArraySize, 0, GL_DEPTH_COMPONENT, GL_FLOAT, NULL);
  ...
  _snprintf(m_strInfo, 1024, "%s, %i%i", strType, m_iSize, m_iArraySize);
  return true;
}
