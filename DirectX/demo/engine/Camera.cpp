...
void Camera::lookAt(const D3DXVECTOR3 &eyePosition, const D3DXVECTOR3 &targetPosition)
{
	...
	//D3DXMATRIX   otherMatrix,translate,rx,ry;
	//D3DXMatrixTranslation(&translate, _eyePosition.x, _eyePosition.y, _eyePosition.z);
	//D3DXMatrixRotationX(&rx, _roll/RADIANS_FACTOR);
	//D3DXMatrixRotationY(&ry, _pitch/ RADIANS_FACTOR);
	//otherMatrix = translate * ry * rx ;
}
