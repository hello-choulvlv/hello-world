...
void EventManager::dispatchTouchEvent(TouchState touchState, const float_2 &touchPoint)
{
...
void EventManager::dispatchMouseEvent(MouseType mouseType, MouseState mouseState, const float_2 &mousePoint)
{
...
void EventManager::removeListener(SceneTracer *obj)
{
	std::vector<TouchEventListener *>::iterator  it = _touchEventArrays.begin();
