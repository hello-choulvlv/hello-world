...
public:
	...
	mat2x2f();
	~mat2x2f();
	mat2x2f(const mat2x2f &Matrix);
	mat2x2f(const vec2 &col1, const vec2 &col2);
	mat2x2f(float c1r1, float c1r2, float c2r1, float c2r2);
	explicit mat2x2f(const mat3x3f &Matrix);
	explicit mat2x2f(const mat4x4f &Matrix);
	mat2x2f& operator = (const mat2x2f &Matrix);
	float& operator [] (int i);
	float* operator & ();
	friend mat2x2f operator * (const mat2x2f &Matrix1, const mat2x2f &Matrix2);
	friend vec2 operator * (const mat2x2f &Matrix, const vec2 &u);
};
...
public:
	...
	mat3x3f();
	~mat3x3f();
	mat3x3f(const mat3x3f &Matrix);
	mat3x3f(const vec3 &col1, const vec3 &col2, const vec3 &col3);
	mat3x3f(float c1r1, float c1r2, float c1r3, float c2r1, float c2r2, float c2r3, float c3r1, float c3r2, float c3r3);
	explicit mat3x3f(const mat2x2f &Matrix);
	explicit mat3x3f(const mat4x4f &Matrix);
	mat3x3f& operator = (const mat3x3f &Matrix);
	float& operator [] (int i);
	float* operator & ();
	friend mat3x3f operator * (const mat3x3f &Matrix1, const mat3x3f &Matrix2);
	friend vec3 operator * (const mat3x3f &Matrix, const vec3 &u);
};
...
public:
	...
	mat4x4f();
	~mat4x4f();
	mat4x4f(const mat4x4f &Matrix);
	mat4x4f(const vec4 &col1, const vec4 &col2, const vec4 &col3, const vec4 &col4);
	mat4x4f(float c1r1, float c1r2, float c1r3, float c1r4, float c2r1, float c2r2, float c2r3, float c2r4, float c3r1, float c3r2, float c3r3, float c3r4, float c4r1, float c4r2, float c4r3, float c4r4);
	explicit mat4x4f(const mat2x2f &Matrix);
	explicit mat4x4f(const mat3x3f &Matrix);
	mat4x4f& operator = (const mat4x4f &Matrix);
	float& operator [] (int i);
	float* operator & ();
	friend mat4x4f operator * (const mat4x4f &Matrix1, const mat4x4f &Matrix2);
	friend vec4 operator * (const mat4x4f &Matrix, const vec4 &u);
};

// ----------------------------------------------------------------------------------------------------------------------------

extern mat4x4f BiasMatrix;
extern mat4x4f BiasMatrixInverse;
